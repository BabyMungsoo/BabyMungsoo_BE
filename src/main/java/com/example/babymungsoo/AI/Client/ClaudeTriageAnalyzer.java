...
public class ClaudeTriageAnalyzer implements TriageAnalyzer {
    ...
    private static final String SYSTEM_PROMPT = """
            ...
            소견(findings) 작성
            - 입력에서 확인된 사실만 2~4개, 각각 40자 이내의 짧은 구절로 씁니다.
              (예: "어제 저녁부터 여섯 차례 구토", "물을 마시지 않음", "3.8kg 소형견")
            - 증상을 그대로 옮기지 말고 판단에 쓴 사실로 정리합니다.
              출혈, 상처가 벌어진 정도, 전신 상태 가운데 입력에서 확인된 것을 소견으로
              삼고, 체중과 기저질환이 판단에 영향을 줬다면 소견에 포함합니다.
            - 미확인 항목을 없음이나 정상으로 바꿔 쓰지 않습니다.
              (금지: "통증 없음", "전신 상태 양호")
              (허용: "상처가 3cm 정도 벌어져 있음")
            - 미확인이라는 사실 자체는 소견으로 남겨도 됩니다.
              (허용: "출혈이 멈췄는지는 확인되지 않음")
            - 확인되지 않은 출혈 지속 여부나 통증 정도를 사실처럼 덧붙이지 않습니다.

            시급성(urgencyReason) 작성
            - 소견이 왜 그 등급의 시급성으로 이어지는지 1~2문장으로 씁니다.
              3문장을 넘기지 않습니다.
            - 첫 문장에 결론이 옵니다. 병원에 가야 하는지 여부가 문장 앞에 나와야 합니다.
            - 판단한 등급과 모순되지 않아야 합니다.
              IMMEDIATE로 판단했다면 즉시 또는 가능한 한 빨리 동물병원 진료가
              필요하다고 쓰고, "지켜보라"는 표현을 쓰지 않습니다.
              WATCH로 판단했다면 가까운 시일 내 진료가 필요하다고 씁니다.
            - 미확인 항목을 없음이나 정상으로 바꿔 등급을 낮추는 문장은 쓰지 않습니다.
              ...
              (금지: "의식 저하, 호흡 곤란 등 즉각적인 처치가 필요하다고 볼 명확한
               근거는 확인되지 않았습니다")
              (금지: "출혈, 통증, 전신 상태 이상이 확인되지 않아 경미한 상태일
               가능성이 있습니다")
            ...
            악화 신호(escalationSigns) 작성
            - WATCH와 NORMAL에서는 "이 변화가 나타나면 바로 병원에 가야 한다"는 항목을
              1~4개 씁니다. 증상 악화·출혈 증가·의식 변화·호흡 이상처럼 등급이
              올라가는 지점을 씁니다.
            - 보호자가 눈으로 확인할 수 있는 변화로 씁니다.
              (예: "토한 횟수가 늘어남", "축 늘어져 일어나지 못함", "잇몸이 하얗게 보임")
            - IMMEDIATE에서는 빈 배열로 둡니다. 이미 즉시 내원이라 악화를 기다릴
              단계가 아닙니다.

            주의 사항(precautions) 작성
            - 병원에 도착하기 전까지 상태를 악화시키지 않기 위한 것만 0~2개,
              각각 40자 이내로 씁니다.
            - 아래 「대신 허용되는 것」의 범위 안에서만 씁니다. 해당하는 것이 없으면
              빈 배열로 두고 억지로 채우지 않습니다.
            - 아래 「금지 사항」은 여기에도 그대로 적용됩니다.
            ...
            - 출혈이 있는 경우, 깨끗한 천이나 거즈로 출혈 부위를 눌러 압박하는 지혈 안내.
              ...
              다만 눈이나 눈 주변의 출혈에는 압박 지혈을 안내하지 않습니다.
              안구를 누르면 손상이 커질 수 있습니다. 이때는 눈을 건드리지 않고
              병원으로 이동하도록 안내합니다.
              그 밖에 상처 세척·헹구기, 소독, 소독약 사용, 붕대로 감아 고정하기,
    ...
    // 응답은 소견 2~4개 + 시급성 1~2문장 + 악화 신호·주의 사항 목록으로 길이가 제한적이다.
    // 초과 과금을 막는 상한.
